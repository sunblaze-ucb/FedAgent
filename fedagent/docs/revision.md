...
| env-service port bands (all 352 generated configs) | ephemeral-safe: paper 10000+/16384+, accel 22528+/28672+ | 2026-08-19 | — | [bugfix](./bugfixes.md): the old ALFWorld bands (40000+/52224+) and the top third of accel-WebShop sat inside the kernel ephemeral range and could be squatted mid-run. **Every generated config's ports change**; runs in flight keep their own ports (resume is port-agnostic), and configs one cycle apart now share a band by design |
